 ...
 * 
 * UriRewriteFilter from https://github.com/jasonlewis/basset/blob/master/src/Basset/Filter/UriRewriteFilter.php
 */
class AssetCssUriRewriteFilter implements FilterInterface {
    ...
    {
        $this->documentRoot = public_path();//$this->realPath($documentRoot ?: $_SERVER['DOCUMENT_ROOT']);
